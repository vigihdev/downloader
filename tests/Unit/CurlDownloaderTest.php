...
use Vigihdev\Downloader\CurlDownloader;
...
{
    private CurlDownloader $downloader;
    ...
    protected function setUp(): void
    {
        ...
        $this->testDir = sys_get_temp_dir() . "/curl-downloader-test-" . uniqid();
    ...
    /** @test */
    public function it_handles_curl_specific_features(): void
    {
    ...
    public function it_fails_for_non_image_content(): void
    {
        ...
        $this->assertInstanceOf(DownloadResult::class, $result);
        $this->assertFalse($result->isSuccess());
        $this->assertStringContainsString("mime", strtolower($result->getError() ?? ""));
    }
}
